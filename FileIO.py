...
# Step 2a: Open a file to write
with open("students.csv", "w", newline="") as file:
    # Step 2b: Create a writer object
    writer = csv.writer(file)
    
    # Step 2c: Write the header row
    writer.writerow(["Name", "Math", "Science", "English"])
    
    # Step 2d: Write data rows
    writer.writerow(["Harshal", 90, 85, 92])
    writer.writerow(["Anita", 78, 88, 80])
